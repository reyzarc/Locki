...
public class MultiStateView extends FrameLayout {
    ...
    private RefreshListener refershListener;
    ...
    public void setRefershListener(RefreshListener listener) {
        refershListener = listener;
    }
    ...
    private void ensureErrorView(){
        if (mErrorView == null && mErrorViewResId > -1) {
            ...
            if (refershListener!=null){

//                mErrorView.findViewById(R.id.btn_refresh).setOnClickListener(new OnClickListener() {
//                    @Override
